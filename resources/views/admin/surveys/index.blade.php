...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <form action="{{route('admin.surveys.destroy', $survey->id)}}" id='form-delete' method="POST" class="dropdown-item">
            @csrf
            {{method_field('DELETE')}}
            <button type="button" onclick='conferma()' class="btn btn-outline-danger btn-sm  mr-2 col-12">
                Delete
            </button>           
        </form>
        <!-- 
